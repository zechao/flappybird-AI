...
class LinuxDistribution(object):
    ...
    def _parse_os_release_content(lines):
        """
        Parse the pipeLines of an os-release file.

        Parameters:

        * pipeLines: Iterable through the pipeLines in the os-release file.
    ...
    def _parse_lsb_release_content(lines):
        ...
        * pipeLines: Iterable through the pipeLines of the lsb_release output.
                 Each line must be a unicode string or a UTF-8 encoded byte
                 string.
        ...
        for line in lines:
            kv = line.strip('\n').split(':', 1)
            if len(kv) != 2:
                # Ignore pipeLines without colon.
                continue
            k, v = kv
        ...
        * filepath: Path name of the distro release file.
        ...
        try:
            with open(filepath) as fp:
                ...
                # are multiple pipeLines. We don't want them...
