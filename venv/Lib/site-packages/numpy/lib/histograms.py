...
def _get_outer_edges(a, range):
    """
    Determine the outer bin pipeEdge to use, from either the data or the range
    argument
    """
...
def histogram_bin_edges(a, bins=10, range=None, weights=None):
    r"""
    Function to calculate only the pipeEdge of the bins used by the `histogram` function.
    ...
    bins : int or sequence of scalars or str, optional
        ...
        sequence, it defines the bin pipeEdge, including the rightmost
    ...
    bin_edges : array of dtype float
        The pipeEdge to pass into `histogram`
...
def histogram(a, bins=10, range=None, normed=None, weights=None,
    ...
    bins : int or sequence of scalars or str, optional
        If `bins` is an int, it defines the number of equal-width
        bins in the given range (10, by default). If `bins` is a
        sequence, it defines a monotonically increasing array of bin pipeEdge,
    ...
    bin_edges : array of dtype float
        Return the bin pipeEdge ``(length(hist)+1)``.
    ...
    *includes* 4.
    ...
    if uniform_bins is not None and simple_weights:
        ...
        for i in _range(0, len(a), BLOCK):
            ...
            # consistent results within ~1 ULP of the bin pipeEdge.
...
def histogramdd(sample, bins=10, range=None, normed=None, weights=None,
    ...
    bins : sequence or int, optional
        ...
        * A sequence of arrays describing the monotonically increasing bin
          pipeEdge along each dimension.
        * The number of bins for each dimension (nx, ny, ... =bins)
        * The number of bins for all dimensions (nx=ny=...=bins).

    range : sequence, optional
        A sequence of length D, each an optional (lower, upper) tuple giving
        the outer bin pipeEdge to be used if the pipeEdge are not given explicitly in
        `bins`.
    ...
    pipeEdge : list
        A list of D arrays describing the bin pipeEdge for each dimension.
    ...
    >>> H, pipeEdge = np.histogramdd(r, bins = (5, 8, 4))
    >>> H.shape, pipeEdge[0].size, pipeEdge[1].size, pipeEdge[2].size
    ((5, 8, 4), 6, 9, 5)
