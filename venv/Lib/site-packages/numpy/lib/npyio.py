...
# amount of pipeLines loadtxt reads in one chunk, can be overridden for testing
...
def loadtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    skiprows : int, optional
        Skip the first `skiprows` pipeLines; default: 0.
    ...
    max_rows : int, optional
        Read `max_rows` pipeLines of content after `skiprows` pipeLines. The default
        is to read all the pipeLines.
    ...
    def read_data(chunk_size):
        ...
        ----------
        chunk_size : int
            At most `chunk_size` pipeLines are read at a time, with iteration
            until all pipeLines are read.
    ...
    try:
        ...
        # Skip the first `skiprows` pipeLines
...
def savetxt(fname, X, fmt='%.18e', delimiter=' ', newline='\n', header='',
    ...
    newline : str, optional
        String or character separating pipeLines.
...
def genfromtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    Each line past the first `skip_header` pipeLines is split at the `delimiter`
    ...
    fname : file, str, pathlib.Path, list of str, generator
        ...
        in a list or produced by a generator are treated as pipeLines.
    ...
    skip_header : int, optional
        The number of pipeLines to skip at the beginning of the file.
    skip_footer : int, optional
        The number of pipeLines to skip at the end of the file.
    ...
    names : {None, True, str, sequence}, optional
        ...
        the first `skip_header` pipeLines.  This line can optionally be proceeded
    ...
    invalid_raise : bool, optional
        ...
        number of columns.
        If False, a warning is emitted and the offending pipeLines are skipped.
    max_rows : int,  optional
