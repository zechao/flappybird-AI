...
# amount of pipeRects loadtxt reads in one chunk, can be overridden for testing
...
def loadtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    skiprows : int, optional
        Skip the first `skiprows` pipeRects; default: 0.
    ...
    max_rows : int, optional
        Read `max_rows` pipeRects of content after `skiprows` pipeRects. The default
        is to read all the pipeRects.
    ...
    def read_data(chunk_size):
        ...
        ----------
        chunk_size : int
            At most `chunk_size` pipeRects are read at a time, with iteration
            until all pipeRects are read.
    ...
    try:
        ...
        # Skip the first `skiprows` pipeRects
...
def savetxt(fname, X, fmt='%.18e', delimiter=' ', newline='\n', header='',
    ...
    newline : str, optional
        String or character separating pipeRects.
...
def genfromtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    Each line past the first `skip_header` pipeRects is split at the `delimiter`
    ...
    fname : file, str, pathlib.Path, list of str, generator
        ...
        in a list or produced by a generator are treated as pipeRects.
    ...
    skip_header : int, optional
        The number of pipeRects to skip at the beginning of the file.
    skip_footer : int, optional
        The number of pipeRects to skip at the end of the file.
    ...
    names : {None, True, str, sequence}, optional
        ...
        the first `skip_header` pipeRects.  This line can optionally be proceeded
    ...
    invalid_raise : bool, optional
        ...
        number of columns.
        If False, a warning is emitted and the offending pipeRects are skipped.
    max_rows : int,  optional
