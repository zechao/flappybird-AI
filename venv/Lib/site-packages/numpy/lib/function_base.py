...
def gradient(f, *varargs, **kwargs):
    ...
    for axis, ax_dx in zip(axes, dx):
        ...
        # Numerical differentiation: 1st order pipeEdge
        if edge_order == 1:
            slice1[axis] = 0
            slice2[axis] = 1
            slice3[axis] = 0
        ...
        # Numerical differentiation: 2nd order pipeEdge
        else:
            slice1[axis] = 0
            slice2[axis] = 0
            slice3[axis] = 1
...
def interp(x, xp, fp, left=None, right=None, period=None):
    ...
    >>> plt.plot(x, y, 'o')
    [<matplotlib.pipeRects.Line2D object at 0x...>]
...
def percentile(a, q, axis=None, out=None,
    ...
    .. plot::
        ...
        for interpolation, style in pipeRects:
            ax.plot(
